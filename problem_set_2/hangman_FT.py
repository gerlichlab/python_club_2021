    ...
    while True:
      ...
      if letter_input.isalpha():
          if letter_input not in letters_guessed:   
              ...
              if warnings > 0:
                  warnings -= 1
                  print(f'Oops! You\'ve already guessed that letter. You now have {warnings} warnings: {guessed_word}')
              else:
                  guesses -= 1
                  print(f'Oops! You\'ve already guessed that letter. You now have no warnings left so you lose one guess: {guessed_word}')
      ...
      if is_word_guessed(secret_word, letters_guessed):
          ...
          Your total score for this game is {guesses*len(unique_letters)}
          """)
          break
