...
def hangman(secret_word):
    ...
    while True:
        ...
        if letter_input.isalpha():
            ...
            number_guesses -=1
            print ("""You have run out of warnings and have made an invalid input. You lose one guess.""")
                ...
                #if letter_input not in letters_guessed:
                      #unique_letters.append(letter_input)
                      #if letter_input in unique_letters:
                            #if number_warnings > 0:
                                  #number_warnings -=1
                                  #print(""" Oops! You've already guessed that letter. You now have {number_warnings} warnings left""")
                            #else: number_guesses -=1
                            #print ("""You have run out of warnings and have already guessed this letter You lose one guess.""")
